...
import { useCloudImageElementState, type TCloudImageElement } from "@udecode/plate-cloud"
...
export interface CloudImageElementProps extends PlateElementProps<Value, TCloudImageElement> {}

export function CloudImageElement({ className, ...props }: CloudImageElementProps) {
  const { children, element } = props

  const { focused, selected, setSize, size, src, srcSet, upload } = useCloudImageElementState({
    element,
  })
